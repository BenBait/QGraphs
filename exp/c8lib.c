...
*/
{
  ...
  if ( fabs ( creal ( x ) ) + fabs ( cimag ( x ) ) <= 
       fabs ( creal ( y ) ) + fabs ( cimag ( y ) ) )
  {
    value = 1;
  }
  else
...
*/
{
  ...
  if ( fmax ( fabs ( creal ( x ) ), fabs ( cimag ( x ) ) ) <= 
       fmax ( fabs ( creal ( y ) ), fabs ( cimag ( y ) ) ) )
  {
    value = 1;
  }
  else
...
*/
{
  ...
  value = fmax ( fabs ( creal ( x ) ), fabs ( cimag ( x ) ) );
